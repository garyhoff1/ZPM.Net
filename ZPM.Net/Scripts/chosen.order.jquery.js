  ...
  AbstractChosenOrder = (function() {
    ...
    AbstractChosenOrder.setSelectionOrder = function(select, order, force) {
      ...
      if (order instanceof Array) {
        //order = order.map(Function.prototype.call, String.prototype.trim); -- use $.trim.  String.prototype.trim doesn't like extra parms that map sends on some browsers
        order = order.map($.trim);
        options = this.getFlattenedOptionsAndGroups(select);
